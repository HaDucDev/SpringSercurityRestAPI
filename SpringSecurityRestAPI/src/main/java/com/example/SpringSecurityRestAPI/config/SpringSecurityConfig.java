...
import com.example.SpringSecurityRestAPI.config.service.UserDetailsServiceImpl;
...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)//@prePostEnabled de phan quyen
